...
function autocomplete(inp, arr) {
    ...
    inp.addEventListener("keyup", function (e) {
        if (e.keyCode != 13 && e.keyCode != 40 && e.keyCode != 38) { // not Enter,Up,Down arrow
            ...
            /*đóng mọi danh sách giá trị đã mở*/
            closeAllLists();
            if (!val) {
                return false;
            }
            ...
            /*tạo một phần tử DIV sẽ chứa các mục (giá trị):*/
            a = document.createElement("DIV");
            a.setAttribute("id", this.id + "autocomplete-list");
            a.setAttribute("class", "autocomplete-items");

            /*nối thêm phần tử DIV với tư cách là phần tử con của vùng chứa tự động hoàn thành:*/
            this.parentNode.appendChild(a);

            /*cho từng mục trong mảng ...*/
            for (i = 0; i < arr.length; i++) {
                /*kiểm tra xem mục có bắt đầu bằng các chữ cái giống như giá trị văn bản hay không:*/
                if (arr[i].name.substr(0, val.length).toUpperCase() == val.toUpperCase()) {

                    /*tạo một phần tử DIV cho từng phần tử phù hợp:*/
                    b = document.createElement("DIV");

                    /*làm cho các chữ cái in đậm:*/
                    b.innerHTML = "<strong>" + arr[i].name.substr(0, val.length) + "</strong>";
                    b.innerHTML += arr[i].name.substr(val.length);

                    /*chèn một giá trị đầu vào sẽ giữ giá trị của mục mảng hiện tại:*/
                    b.innerHTML += "<input type='hidden' value='" + arr[i].name + "'>";

                    /*thực thi một chức năng khi ai đó nhấp vào giá trị (phần tử DIV):*/
                    b.addEventListener("click", function (e) {
                        /*chèn giá trị cho trường văn bản:*/
                        inp.value = this.getElementsByTagName("input")[0].value;
                        inp.focus();

                        /*đóng danh sách các giá trị tự,
                        (hoặc bất kỳ danh sách mở nào khác:*/
                        closeAllLists();
                    });
                    a.appendChild(b);
                }
    ...
    /*thực hiện một chức năng nhấn một phím trên bàn phím:*/
    inp.addEventListener("keydown", function (e) {
        var x = document.getElementById(this.id + "autocomplete-list");
        if (x) x = x.getElementsByTagName("div");
        if (e.keyCode == 40) {
            /*Nếu nhấn phím mũi tên DOWN, hãy tăng biến currentFocus:*/
            currentFocus++;
            /*làm cho mục hiện tại hiển thị rõ hơn:*/
            addActive(x);
            ...
            /*Nếu phím ENTER được nhấn, ngăn không cho gửi biểu mẫu,*/

            if (currentFocus > -1) {
                /* mô phỏng một cú nhấp chuột vào mục "đang hoạt động":*/
                if (x) {
    ...
    function addActive(x) {
        /*một chức năng để phân loại một mục là "active":*/
        if (!x) return false;
        /*bắt đầu bằng cách xóa lớp"active":*/
        removeActive(x);
    ...
    function removeActive(x) {
        /*một chức năng để xoá lớp "active" :*/
    ...
    function closeAllLists(elmnt) {
        /*đóng tất cả các danh sách trong tài liệu, ngoại trừ danh sách được chuyển làm đối số:*/
    ...
    /*thực thi một chức năng khi ai đó nhấp vào tài liệu:*/
...
function shuffleArray(array) {
    ...
    // Trong khi vẫn còn các yếu tố để xáo trộn...
    while (currentIndex != 0) {
        ...
        // Và trao đổi nó với phần tử hiện tại.
